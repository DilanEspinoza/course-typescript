...
let cualquierCosa: any = "Esto es un texto";
cualquierCosa = 21;
...
let nose: unknown = "nose";

if (typeof nose === "string") {
	console.log(`Esta es la longitud del texto: ${nose.length}`); // Safe, TypeScript sabe que es un string
}
